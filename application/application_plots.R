...
for(t in t_inds){
  ...
  #plot(p0)
  p1 = p0 +scale_fill_stepsn(breaks=brks,colors=cols,name=expression(alpha),limits=range(brks))+theme(legend.key.size = unit(0.8, "in"),
  ...
  ggsave(p2, filename =paste0("application/Figures/loc_t",t,"_median.pdf"),
  ...
  p0 = ggp +  theme(axis.line = element_blank(),
                    ...
                    plot.margin = unit(c(0, 0, -1, -1), 'lines'))+geom_tile(data, mapping = aes(x = lon, y = lat, fill = value), width = 0.27, height = 0.27) + xlab("") + ylab("")
  #plot(p0)
  p1 = p0 +scale_fill_stepsn(breaks=brks,colors=cols,name=expression(s),limits=range(brks))+theme(legend.key.size = unit(0.8, "in"),
                                                                                       legend.text=element_text(size=15),
                                                                                       legend.title = element_text(size=20),
                                                                                       plot.background = element_rect(fill = "transparent", colour = NA),
                                                                                       legend.background  = element_rect(fill = "transparent", colour = NA),
  ...
  p2 = p1 + geom_path(data=world, aes(x=long, y=lat, group=group), colour="black") 
  p2 <- p2 + theme(rect = element_rect(fill = "transparent"))
  ggsave(p2, filename =paste0("application/Figures/s_t",t,"_median.pdf"),
         height = 6, width = 6, bg="transparent")
  ...
  p0 = ggp +  theme(axis.line = element_blank(),
                    ...
                    plot.margin = unit(c(0, 0, -1, -1), 'lines'))+geom_tile(data, mapping = aes(x = lon, y = lat, fill = value), width = 0.27, height = 0.27) + xlab("") + ylab("")
  #plot(p0)
  p1 = p0 +scale_fill_stepsn(breaks=brks,colors=cols,name=expression(xi),limits=range(brks))+theme(legend.key.size = unit(0.8, "in"),
                                                                                       legend.text=element_text(size=15),
                                                                                       legend.title = element_text(size=20),
                                                                                       plot.background = element_rect(fill = "transparent", colour = NA),
                                                                                       legend.background  = element_rect(fill = "transparent", colour = NA),
  ...
  p2 = p1 + geom_path(data=world, aes(x=long, y=lat, group=group), colour="black") 
  p2 <- p2 + theme(rect = element_rect(fill = "transparent"))
  ggsave(p2, filename =paste0("application/Figures/xi_t",t,"_median.pdf"),
         height = 6, width = 6, bg="transparent")
  ...
  p0 = ggp +  theme(axis.line = element_blank(),
                    ...
                    plot.margin = unit(c(0, 0, -1, -1), 'lines'))+geom_tile(data, mapping = aes(x = lon, y = lat, fill = value), width = 0.27, height = 0.27) + xlab("") + ylab("")
  #plot(p0)
  p1 = p0 +scale_fill_stepsn(breaks=brks,colors=cols,name=expression(Y),limits=range(brks))+theme(legend.key.size = unit(0.8, "in"),
                                                                                       legend.text=element_text(size=15),
                                                                                       legend.title = element_text(size=20),
                                                                                       plot.background = element_rect(fill = "transparent", colour = NA),
                                                                                       legend.background  = element_rect(fill = "transparent", colour = NA),
  ...
  p2 = p1 + geom_path(data=world, aes(x=long, y=lat, group=group), colour="black") 
  p2 <- p2 + theme(rect = element_rect(fill = "transparent"))
  ggsave(p2, filename =paste0("application/Figures/obs_t",t,"_median.pdf"),
         height = 6, width = 6, bg="transparent")
  print(times[t])
  ...
  p0 = ggp +  theme(axis.line = element_blank(),
                    ...
                    plot.margin = unit(c(0, 0, -1, -1), 'lines'))+geom_tile(data, mapping = aes(x = lon, y = lat, fill = value), width = 0.27, height = 0.27) + xlab("") + ylab("")
  #plot(p0)
  p1 = p0 +scale_fill_stepsn(breaks=brks,colors=cols,name=expression(Q[x](tau)),limits=range(brks))+theme(legend.key.size = unit(0.8, "in"),
                                                                                                   legend.text=element_text(size=15),
                                                                                                   legend.title = element_text(size=20),
                                                                                                   plot.background = element_rect(fill = "transparent", colour = NA),
                                                                                                   legend.background  = element_rect(fill = "transparent", colour = NA),
  ...
  p2 = p1 + geom_path(data=world, aes(x=long, y=lat, group=group), colour="black") 
  p2 <- p2 + theme(rect = element_rect(fill = "transparent"))
  ggsave(p2, filename =paste0("application/Figures/q_0.9_t",t,"_median.pdf"),
         height = 6, width = 6, bg="transparent")
  
  temp= apply(all_preds[t,,,],c(1,3),function(x){
    
    qbGEV(0.99,q_a=x[1],s_b=x[2],xi=x[3],
          alpha=0.5,beta=0.5,p_a=0.05,p_b=0.2,c1=5,c2=5)
  ...
  p2 = p1 + geom_path(data=world, aes(x=long, y=lat, group=group), colour="black") 
  p2 <- p2 + theme(rect = element_rect(fill = "transparent"))
  ggsave(p2, filename =paste0("application/Figures/q_0.99_t",t,"_median.pdf"),
         height = 6, width = 6, bg="transparent")
  
  temp= apply(all_preds[t,,,],c(1,3),function(x){
    
    qbGEV(0.999,q_a=x[1],s_b=x[2],xi=x[3],
          alpha=0.5,beta=0.5,p_a=0.05,p_b=0.2,c1=5,c2=5)
  ...
  p2 = p1 + geom_path(data=world, aes(x=long, y=lat, group=group), colour="black") 
  p2 <- p2 + theme(rect = element_rect(fill = "transparent"))
  ggsave(p2, filename =paste0("application/Figures/q_0.999_t",t,"_median.pdf"),
         height = 6, width = 6, bg="transparent")
  
  temp= apply(all_preds[t,,,],c(1,3),function(x){
    
    qbGEV(0.9999,q_a=x[1],s_b=x[2],xi=x[3],
          alpha=0.5,beta=0.5,p_a=0.05,p_b=0.2,c1=5,c2=5)
  ...
  p2 = p1 + geom_path(data=world, aes(x=long, y=lat, group=group), colour="black") 
  p2 <- p2 + theme(rect = element_rect(fill = "transparent"))
  ggsave(p2, filename =paste0("application/Figures/q_0.9999_t",t,"_median.pdf"),
         height = 6, width = 6, bg="transparent")
...
plot(qexp(ps),qs_med,xlab="Theoretical",ylab="Model",main="",pch=20,
...
p<-ggplot(qq_95)+geom_point(aes(x=t_exp,y=ymedian),size=1.2)+xlim(0,15.2)+ylim(0,15.2)+geom_line(aes(x=t_exp,y=ylow),linetype=5,col="blue")+
  geom_line(aes(x=t_exp,y=yup),linetype=5,col="blue")+labs(x="Theoretical",y="Model")+
  geom_abline(intercept=0,slope=1,col="red")+ theme(text = element_text(size = 26),axis.text.x = element_text(size = 26),axis.text.y=element_text(size = 26))  
